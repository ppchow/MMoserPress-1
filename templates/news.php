            ...
            if($i==1){
              ...
              <div class="row">
                ...
                <div class="large-6 columns">
                    ...
                    <!--<p class="label heading"><?php echo $custom[news_type][0].$pipe_sign.get_the_date("d F Y")?></p> -->
                        ...
                        <a class="whole-div" href="<?php echo get_permalink() ?>"> 
                          <div class="panel">
                            <h4><?php the_title(); ?></h4>
                             ...
                             if($custom["news_type"][0]==""){
                                  $pipe_sign=" ";
                             }else{
                                  $pipe_sign=" | ";
                             } ?>
                            <!--<span class="label"><?php echo $custom["news_type"][0].$pipe_sign ; echo get_the_date("d F Y") ?></span>-->
